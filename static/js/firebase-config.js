...
const firebaseConfig = {
  apiKey: "AIzaSyCm34fJuGsFXUPSk8eHlBECDDajq9ImaOs",
...
export const auth = getAuth(app);        // ← обязательно
export const db = getFirestore(app);     // ← обязательно
export const API_KEY = firebaseConfig.apiKey; // ← обязательно